...
const ProductCard = ({ product }) => {
    ...
    return (
        <div
            className='flex w-full relative flex-col overflow-hidden rounded-lg border border-gray-700 shadow-lg cursor-pointer hover:bg-gray-700 transition duration-300 ease-in-out'
